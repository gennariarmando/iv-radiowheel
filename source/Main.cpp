...
#pragma comment(linker, "/EXPORT:" __FUNCTION__"=" __FUNCDNAME__)
    ...
    static void PopulateTracksMap() {
        ...
        m_TracksMap[0xA4EF53BD] = L"THE SMASHING PUMPKINS~n~1979";
        m_TracksMap[0xA1D9271F] = L"STEVIE NICKS~n~Edge Of Seventeen";
        m_TracksMap[0xA1894C0E] = L"SUCKER DJ'S FEAT. WRAY~n~Salvation (eSQUIRE Remix)";
        m_TracksMap[0x964F7D35] = L"AC/DC~n~Touch Too Much";
        m_TracksMap[0x956CDD08] = L"MTUME~n~C.O.D (I'll Deliver)";
        m_TracksMap[0x9A6819D6] = L"MTUME~n~C.O.D (I'll Deliver)";
        m_TracksMap[0x9A4565D9] = L"THE PRAIRIE CARTEL~n~Homicide";
        m_TracksMap[0x99A9E6E2] = L"TAMIKO JONES~n~Can't Live Without Your Love";
        m_TracksMap[0xB12C6335] = L"IVY QUEEN~n~Dime";
        m_TracksMap[0xB2B36F52] = L"SCRITTI POLITTI~n~Wood Beez (Pray Like Aretha Franklin)";
        m_TracksMap[0xA673FA8A] = L"CRO-MAGS~n~It's The Limit";
        m_TracksMap[0xA5DE13CD] = L"ZVERY~n~Kvartira";
        m_TracksMap[0xAD4B22C5] = L"SPLIN~n~Liniya Zhizni";
        m_TracksMap[0xAD2F2933] = L"SPLIN~n~Liniya Zhizni";
        m_TracksMap[0xAAA327D5] = L"ANGEL Y KHRIZ~n~Ven Bailalo";
        m_TracksMap[0x7BE8991E] = L"MAI TAI~n~History";
        ...
        m_TracksMap[0x918B84C5] = L"TAMIKO JONES~n~Can't Live Without Your Love";
        m_TracksMap[0x92F36DF8] = L"SERYOGA~n~King Ring";
        m_TracksMap[0x85A70D73] = L"AVENTURA~n~El Désprecio";
        m_TracksMap[0x8353CEB9] = L"RANETKI~n~O Tebe";
        m_TracksMap[0x83D62811] = L"ROBBIE NEVIL~n~C'est La Vie";
        m_TracksMap[0x89AEF8CB] = L"THE SMASHING PUMPKINS~n~1979";
        m_TracksMap[0x88719AC2] = L"DAVID BOWIE~n~Fascination";
        m_TracksMap[0xE707ECD5] = L"AVENTURA~n~El Désprecio";
        m_TracksMap[0xEC432EEB] = L"IRON MAIDEN~n~Run To The Hills";
        m_TracksMap[0xE9C319C0] = L"SERYOGA~n~King Ring";
        m_TracksMap[0xE4A7C994] = L"SCRITTI POLITTI~n~Wood Beez (Pray Like Aretha Franklin)";
        m_TracksMap[0xDBB47F79] = L"BASTA~n~Mama";
        m_TracksMap[0xDBE238A0] = L"TEGO CALDERON FEAT. OSCAR D'LEON~n~Llora Llora";
        m_TracksMap[0xFEDC05EB] = L"ROSE ROYCE~n~Still In Love";
        m_TracksMap[0xFDBE1C79] = L"JOHN FARNHAM~n~You're The Voice";
        m_TracksMap[0xFBAB5A07] = L"TERRY RILEY~n~A Rainbow In Curved Air";
        m_TracksMap[0xEFDA32DB] = L"THE DOORS~n~Five To One";
        m_TracksMap[0xED62AD47] = L"LENINGRAD~n~Nikogo Ne Zhalko";
        m_TracksMap[0xEEFCABF1] = L"ANGEL Y KHRIZ~n~Ven Bailalo";
        m_TracksMap[0xF369312A] = L"MARLEY MARL FEAT CRAIG G~n~Droppin' Science";
        m_TracksMap[0xC36D10D4] = L"STEVIE NICKS~n~Edge Of Seventeen";
        m_TracksMap[0xC910DA32] = L"RUSLANA~n~Wild Dances";
        m_TracksMap[0xC71CAEF4] = L"FAT JOE FEAT. LIL WAYNE~n~Crackhouse";
        m_TracksMap[0xBB2DBC82] = L"ZVERY~n~Kvartira";
        m_TracksMap[0xBC3B57E0] = L"THE PRAIRIE CARTEL~n~Homicide";
        m_TracksMap[0xBC0CC8AF] = L"BATHORY~n~Call From The Grave";
        m_TracksMap[0xBE168524] = L"JONATHAN PETERS FEAT. MAYA AZUCENA~n~Music";
        m_TracksMap[0xD6EE2E21] = L"WOMACK & WOMACK~n~Teardrops";
        m_TracksMap[0xD91FCDC9] = L"IVY QUEEN~n~Dime";
        m_TracksMap[0xCC7F5F25] = L"BASTA~n~Mama";
        m_TracksMap[0xCE18EF59] = L"JEFFERSON STARSHIP~n~Jane";
        m_TracksMap[0xCB10B1AB] = L"ÁNGEL Y KHRIZ FEAT. GOCHO & JOHN ERIC~n~Na De Na";
        m_TracksMap[0xCF3D6543] = L"ELO~n~Evil Woman";
        m_TracksMap[0xD078EB46] = L"BRAND NUBIAN~n~All For One";
        m_TracksMap[0x2E3AECCB] = L"DAVID GUETTA FEAT. KELLY ROWLAND~n~When Love Takes Over";
        m_TracksMap[0x3307445E] = L"GIL SCOTT-HERON~n~Home Is Where The Hatred Is";
        m_TracksMap[0x343B735B] = L"RALPH MYERZ & THE JACK HERREN BAND~n~The Teacher";
        m_TracksMap[0x27121996] = L"BATHORY~n~Call From The Grave";
        m_TracksMap[0x24889130] = L"OLEG KVASHA~n~Zelenoglazoe Taksi (club remix)";
        m_TracksMap[0x27E59DC2] = L"LENINGRAD~n~Nikogo Ne Zhalko";
        m_TracksMap[0x3FF7819A] = L"SUCKER DJ'S FEAT. WRAY~n~Salvation (eSQUIRE Remix)";
        m_TracksMap[0x4189559F] = L"KINO~n~Gruppa Krovi";
        m_TracksMap[0x3DF69AD4] = L"FAT JOE FEAT. LIL WAYNE~n~Crackhouse";
        m_TracksMap[0x3E707E84] = L"JONATHAN PETERS FEAT. MAYA AZUCENA~n~Music";
        m_TracksMap[0x4416656F] = L"BLACK SABBATH~n~Heaven And Hell";
        m_TracksMap[0x42CB8F80] = L"WOMACK & WOMACK~n~Teardrops";
        m_TracksMap[0x3565F981] = L"GO WEST~n~We Close Our Eyes";
        m_TracksMap[0x35AC394F] = L"KINO~n~Gruppa Krovi";
        m_TracksMap[0x36E8A6D1] = L"MICHAEL SHRIEVE~n~Communiqué~n~Approach Spiral";
        m_TracksMap[0x363011DC] = L"BILLIE HOLIDAY~n~Fine and Mellow";
        m_TracksMap[0x3C3E3F47] = L"DOLPHIN~n~RAP";
        m_TracksMap[0x3AC10437] = L"THE FUTURE SOUND OF LONDON~n~Lifeforms (Path 6)";
        m_TracksMap[0x0BE7D0C0] = L"TERRY RILEY~n~A Rainbow In Curved Air";
        m_TracksMap[0x108E0F5F] = L"GO WEST~n~We Close Our Eyes";
        m_TracksMap[0x100F6644] = L"RANETKI~n~O Tebe";
        m_TracksMap[0x038ED515] = L"GLUKOZA~n~Schweine";
        m_TracksMap[0x02E44BEE] = L"RUSLANA~n~Wild Dances";
        m_TracksMap[0x044EA426] = L"TEGO CALDERON FEAT. OSCAR D'LEON~n~Llora Llora";
        m_TracksMap[0x068597F0] = L"BLACK SABBATH~n~Heaven And Hell";
        m_TracksMap[0x0670D31B] = L"MARAKESH~n~Jdat";
        m_TracksMap[0x1D788F29] = L"THE DOORS~n~Five To One";
        m_TracksMap[0x1B3724B1] = L"THE FUTURE SOUND OF LONDON~n~Lifeforms (Path 6)";
        m_TracksMap[0x1BA48432] = L"BRAND NUBIAN~n~All For One";
        m_TracksMap[0x23715DCF] = L"ROBBIE NEVIL~n~C'est La Vie";
        m_TracksMap[0x149EF083] = L"ELO~n~Evil Woman";
        m_TracksMap[0x131EEC77] = L"OLEG KVASHA~n~Zelenoglazoe Taksi (club remix)";
        m_TracksMap[0x530788C6] = L"MICHAEL SHRIEVE~n~Communiqué~n~Approach Spiral";
        m_TracksMap[0x598C3B4E] = L"JOHN FARNHAM~n~You're The Voice";
        m_TracksMap[0x63D8947D] = L"MARLEY MARL FEAT CRAIG G~n~Droppin' Science";
        m_TracksMap[0x578AFFAB] = L"IRON MAIDEN~n~Run To The Hills";
        m_TracksMap[0x54138569] = L"RALPH MYERZ & THE JACK HERREN BAND~n~The Teacher";
        m_TracksMap[0x5373C8C0] = L"PAPOOSE~n~Stylin'";
        m_TracksMap[0x5B38A613] = L"DAVID GUETTA FEAT. KELLY ROWLAND~n~When Love Takes Over";
        m_TracksMap[0x539507B1] = L"CRO-MAGS~n~It's The Limit";
        m_TracksMap[0x60522612] = L"DAVID BOWIE~n~Fascination";
        m_TracksMap[0x610A6308] = L"ROSE ROYCE~n~Still In Love";
        m_TracksMap[0x4895E563] = L"JEFFERSON STARSHIP~n~Jane";
        m_TracksMap[0x4DFCD099] = L"GIL SCOTT-HERON~n~Home Is Where The Hatred Is";
        m_TracksMap[0x4B723C60] = L"TESTERS~n~Body Music";
        m_TracksMap[0x6CC820D8] = L"DOLPHIN~n~RAP";
    }
